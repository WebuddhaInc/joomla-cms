...
var com_installer_password   = com_installer_password || '';
var com_installer_ajax_url   = com_installer_ajax_url || '';
var com_installer_totalsize  = com_installer_totalsize || '';
var com_installer_return_url = com_installer_return_url || '';
...
doEncryptedAjax = function(data, successCallback, errorCallback)
{
	...
	if( com_installer_password.length > 0 )
	{
		json = AesCtr.encrypt( json, com_installer_password, 128 );
	}
	var post_data = {
		'json':     json
	};
